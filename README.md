...
# סיכום אישי: 
במהלך הפרויקט הרגשתי שאני מאתגר את עצמי לכתוב תוכנה יותר מסובכת ממה אני רגיל לכתוב ושאני משתפר בלכתוב באסמבלי אבל שמחתי מאוד לראות את התוצר שיצרתי בסוף וזה היתה הרגשה מאוד מספקת לדעת שעשיתי את כול זה
